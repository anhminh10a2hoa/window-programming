...
{
    public partial class GetAllCustomer : Form
    {
        MainForm mainForm;
        string connectionString;
        public GetAllCustomer(MainForm mainForm, string connectionString)
        {
        ...
        private void GetAllCustomer_Load(object sender, EventArgs e)
        {
            try
            {
